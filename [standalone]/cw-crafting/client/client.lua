        ...
        if benchType.locations then
            for j, benchLoc in pairs(benchType.locations) do
                if Config.useOxTarget then
                    ...
                    exports['qb-target']:AddBoxZone('crafting_' .. benchType.title .. '_' .. j, benchLoc, 1.5, 1.5, {
                        name = 'crafting_' .. benchType.title .. '_' .. j,
                        heading = 0,
                        debugPoly = useDebug,
                        minZ = benchLoc.z - 0.5,
                        maxZ = benchLoc.z + 0.5,
...
local function generateBlueprintOptions(dude, oxTarget)
    local bpOptions = {}
