...
Config.custom_scripts_compatibility = {
	...
	['inventory'] = "ps-inventory",					-- [ox_inventory|qs-inventory|ps-inventory|tgiann-inventory|default|other] Inventory script Compatibility
	...
	['notification'] = "okokNotify",				-- [okokNotify|qbcore|ox_lib|default|other] Notification script Compatibility
